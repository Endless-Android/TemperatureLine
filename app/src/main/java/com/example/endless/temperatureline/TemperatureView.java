package com.example.endless.temperatureline;
...
public class TemperatureView extends View {
    ...
    public void initXValueData(){
        ...
        Log.e("aaaaaaaaaaaaaa", "数据的个数: "+XNum);
        //得到距离最左边的距离
        float BaseWidth=ChartWidth/(XNum*2);
        Log.e("aaaaaaaaaaaaaa", "距离最左边的距离: "+BaseWidth);
        //得到各点之间的间隔
        float tempWdith=BaseWidth*2;

        Log.e("aaaaaaaaaaaaaa", "各点之间的间隔: "+tempWdith);
    ...
    public void initYValueData(){
        ...
        Log.e("aaaaaaaaaaaaaa", "温差: "+parts);
        //y轴一端到控件一端的距离
        float length = CircleTextSize+mRadius+marginHeigh;
        Log.e("aaaaaaaaaaaaaa", "y轴一端到控件一端的距离: "+length);
        //y轴高度
        float yAxisHeight = ChartHeight-length*2;
        Log.e("aaaaaaaaaaaaaa", "y轴高度: "+yAxisHeight);
        ...
        if(parts==0){
            ...
            Log.e("aaaaaaaaaaaaaa", "最小高度值: "+partVlaue);
            for(int i=0;i<YValueMax.size();i++){
                //具体的Y轴坐标数据
                ...
                Log.e("aaaaaaaaaaaaaa", "具体的Y轴坐标数据Max: "+(ChartHeight-partVlaue*(YValueMax.get(i)-tempMin)-length));
                Log.e("aaaaaaaaaaaaaa", "具体的Y轴坐标数据Min: "+(ChartHeight-partVlaue*(YValueMin.get(i)-tempMin)-length));
            }
        }
    }
